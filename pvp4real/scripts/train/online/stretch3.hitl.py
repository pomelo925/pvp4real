...
class AuthorityGUI:
    ...
    def __init__(self, node: Stretch3Authority):
        self._node          = node
        self.quit_requested = False

        self.root = tk.Tk()
        self.root.title("Stretch3 HITL Runtime")
    ...
    def _build_ui(self) -> None:
        r = self.root
        ttk.Label(r, text="Stretch3 HITL Authority", font=("Arial", 14, "bold")).grid(
